...
// 1.2 Once timer reaches it's limit, then the correct, incorrect, and unanswered are counted - invoke count function.
// 1.2.1 JQuery to display the incorrect, incorrect, and unanswered counts html.

// 2.0 JQuery populates the html with 8 questions.
// 2.1 Each question has four input boxes but only one is true.
// 2.2 Do not allow the selection of more then one answer.
// 2.3 User clicks "done" or "submit" for the correct, incorrect, and unanswered are counted - invoke count function.
